...
class ConvNeXt(nn.Module):
    ...
    def __init__(self, in_chans=3,
        ...
        stem = nn.Sequential(
            nn.Conv2d(in_chans, dims[0], kernel_size=4, stride=(4, 4)),
        ...
        for i in range(3):
            downsample_layer = nn.Sequential(
                ...
                nn.Conv2d(dims[i], dims[i + 1], kernel_size=2, stride=(2, 1) if i == 2 else (2, 2)),
            )
        ...
        self.last_pool = nn.MaxPool2d(kernel_size=(3, 1), stride=(1, 1), padding=0)
    ...
    def forward_features(self, x):
        for i in range(4):
            ...
            x = self.stages[i](x)
        return self.norm(self.last_pool(x))
